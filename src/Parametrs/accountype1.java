...
//step1
   ...
   Thread.sleep(2000);
     ...
     driver.findElement(By.xpath("//Span[text()='Send']")).click();
      ...
      driver.findElement(By.xpath("//input[@id='mdcode-input']")).sendKeys("adx");
      driver.findElement(By.xpath("//input[@id='mdname-input']")).sendKeys("account1");
