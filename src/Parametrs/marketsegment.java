...
public class marketsegment {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//button[@class='login-button']")).click();
	       ...
	       driver.findElement(By.xpath("//span[text()='Market Segment']")).click();
	       Thread.sleep(2000);
	   ...
	   // }
		 //  Thread.sleep(1000);
		    driver.findElement(By.xpath("//input[@class='md-input-element ng-pristine ng-valid ng-touched']")).sendKeys("5");
